...
Достаточно Supabase и `UPSTREAM_SUBSCRIPTION_URL`. Панель выдаёт разные защищённые ссылки, позволяет включать/отключать их и задавать описание, срок и отображаемые лимиты.
